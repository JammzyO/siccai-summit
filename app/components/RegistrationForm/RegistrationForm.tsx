    ...
    try {
      ...
      await fetch('https://hook.eu2.make.com/9ui6srn3z482gs9k1wsnu3abdggtcpjp', {
        ...
        body: JSON.stringify({
          ...
          numberOfAttendees:  delegateCount,
          budgetStatus:       BUDGET_LABELS[values.budgetStatus]  || values.budgetStatus,
          registrationTimeline: TIMEFRAME_LABELS[values.timeframe] || values.timeframe,
          preferredContact:   CONTACT_LABELS[values.contactPref]  || values.contactPref,
          invoiceRequired:    values.invoiceNeeded ? 'Yes' : 'No',
          execAssistName:     values.showExecAssist ? values.execAssistName     : '',
          execAssistPhone:    values.showExecAssist ? values.execAssistWhatsapp : '',
