...
export const metadata: Metadata = {
  ...
  description:
    'Join executive leaders, policymakers, and diplomats at the SICC AI Continental Summit on Cybersecurity & AI — 22–26 June 2026, Cape Town International Convention Centre, South Africa.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'An executive summit for C-suite leaders, policymakers, and diplomats across Africa and internationally. 22–26 June 2026, CTICC, Cape Town.',
    siteName: 'SICC AI',
    locale: 'en_ZA',
    type: 'website',
  },
